...
export default function SectionHeading({
  ...
  return (
    <motion.div
      ...
      <h2 className="text-4xl font-extrabold uppercase relative mb-8">
        ...
        <motion.span
          ...
          className="text-7xl -z-10 text-blue-100/50 dark:text-sky-900/20 tracking-widest absolute top-1/2 left-1/2">
          {shadowText}
        </motion.span>
      </h2>
    </motion.div>
