    ...
    <motion.div
      ...
      <section className="relative bg-gray-100 max-w-[42rem] rounded-lg border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem] group-even:pl-8 hover:bg-gray-200 transition">
        ...
        <Image
          ...
          height={300}
          quality={95}
          className="absolute top-8 -right-[55%] w-[28.25rem] rounded-t-lg shadow-2xl transition group-hover:scale-[1.04] group-even:group-hover:translate-x-3 group-even:group-hover:translate-y-3 group-even:group-hover:rotate-2 group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2 group-even:right-[initial] group-even:-left-[55%]"
        />
      </section>
    </motion.div>
  );
